...
def predict_for_file(input_file, output_file, model, batch_size=1, save_logs=0) -> list:
...
def gec():
    ...
    parser.add_argument('--model_path',
                        ...
                        default='./gec_model/bert_0_gectorv2.th',
                        )
    ...
    parser.add_argument('--input_file',
                        ...
                        default='./gec_input/input.txt'
                        )
    parser.add_argument('--output_file',
                        help='Path to the output file',
                        default='./gec_output/output.txt'
                        )
    ...
    args.model_path = ['./gec_model/bert_0_gectorv2.th']
    #print(args)
    return gec_check(args)
